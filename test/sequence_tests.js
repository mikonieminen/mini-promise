;(function() {
    var Sequence = require('../mini-promise.js').Sequence;
    ...
    describe("Sequence Tests", function() {
        it("Single synchronous payload function. Results with ready event after one progress event.", function(done) {
            var e = {
                progress: 1,
                ready: 1
            };
            var v = new Validator(e, done);
            var p = new Sequence(function(ready, error, abort) {
            ...
            p.on("progress", function(index, items) {
                if (index === 0 && items === "car") {
                    v.resolved("progress");
                } else {
        ...
        it("Two synchronous payload functions. Results with ready event after two progress events.", function(done) {
            ...
            p.on("progress", function(index, items) {
                if (index === 0 && items == "car" || index == 1 && items == "train") {
                    v.resolved("progress");
                } else {
                    done(new Error("Data passed in \"progress\" does not match with expected."));
                }
        ...
        it("Three synchronous payload functions. Results with ready event after three progress events.", function(done) {
            ...
            p.on("progress", function(index, items) {
                if (index === 0 && items == "car" || index == 1 && items == "train" || index == 2 && items == "boat") {
                    v.resolved("progress");
                } else {
                    done(new Error("Data passed in \"progress\" does not match with expected."));
                }
        ...
        it("Two asynchronous payload functions. Rsults with two progress events and ready.", function(done) {
            var e = {
                progress: 2,
                ready: 1
            };
        ...
        it("Three asynchronous payload functions, first failing. Results with error.", function(done) {
            ...
            p.on("progress", function(index, items) {
                done(new Error("Should not get progress, when first function failes"));
            });
            p.on("error", function(err) {
                v.resolved("error");
            });
        ...
        it("Three synchronous payload functions, second failing. Results with error after one progress event.", function(done) {
            var e = {
                progress: 1,
                error: 1
            };
        ...
        it("Synchronous and two asynchronous payload functions. Results with two progress events and ready.", function(done) {
            var e = {
                progress: 3,
                ready: 1
            };
